...
import '/componentes/card_confirmar_accion_eliminar/card_confirmar_accion_eliminar_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import 'package:easy_debounce/easy_debounce.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'eliminar_cliente_model.dart';
export 'eliminar_cliente_model.dart';

class EliminarClienteWidget extends StatefulWidget {
  const EliminarClienteWidget({super.key});

  @override
  State<EliminarClienteWidget> createState() => _EliminarClienteWidgetState();
}

class _EliminarClienteWidgetState extends State<EliminarClienteWidget> {
  late EliminarClienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EliminarClienteModel());
                                    ...
                                    await showModalBottomSheet(
                                      ...
                                      builder: (context) {
                                        return Padding(
                                          ...
                                          child:
                                              CardConfirmarAccionEliminarWidget(
                                            paramClientes: listViewUsersRecord,
                                          ),
                                        );
                                      },
