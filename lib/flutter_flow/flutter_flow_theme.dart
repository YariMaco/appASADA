...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF83DBF2);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFF1865C1);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF1865C1);
  late Color alternate = const Color(0xFFE6F7FF);
  late Color primaryText = const Color(0xFF8C8C9C);
  late Color secondaryText = const Color(0xFFAAB8C0);
  late Color primaryBackground = const Color(0xFF1D2428);
  late Color secondaryBackground = const Color(0xFF1B1B1B);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFF3C3C3C);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);
