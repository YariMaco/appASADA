  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> cambiarContrasenaUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final cambiarContrasenaUsersRecord =
            cambiarContrasenaUsersRecordList.isNotEmpty
                ? cambiarContrasenaUsersRecordList.first
                : null;
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Te enviaremos un correo electrónico con un enlace \npara restablecer tu contraseña. Por favor, ingresa el \ncorreo electrónico asociado a tu cuenta a continuación.',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Nunito',
