...
import 'card_crear_abonado_model.dart';
export 'card_crear_abonado_model.dart';

class CardCrearAbonadoWidget extends StatefulWidget {
  const CardCrearAbonadoWidget({super.key});

  @override
  State<CardCrearAbonadoWidget> createState() => _CardCrearAbonadoWidgetState();
}

class _CardCrearAbonadoWidgetState extends State<CardCrearAbonadoWidget> {
  late CardCrearAbonadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardCrearAbonadoModel());

    _model.textFieldNombreTextController ??= TextEditingController();
    _model.textFieldNombreFocusNode ??= FocusNode();

    _model.textIdentificacionTextController ??= TextEditingController();
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await AbonadosRecord.collection
                                      .doc()
                                      .set(createAbonadosRecordData(
                                  ...
                                  safeSetState(() {
                                    ...
                                    _model.textFieldTelefonoTextController
                                        ?.clear();
                                    _model.textDireccionTextController?.clear();
                                  });
