...
import 'card_registro_tarifa_model.dart';
export 'card_registro_tarifa_model.dart';

class CardRegistroTarifaWidget extends StatefulWidget {
  const CardRegistroTarifaWidget({super.key});

  @override
  State<CardRegistroTarifaWidget> createState() =>
      _CardRegistroTarifaWidgetState();
}

class _CardRegistroTarifaWidgetState extends State<CardRegistroTarifaWidget> {
  late CardRegistroTarifaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardRegistroTarifaModel());
    ...
    _model.textFieldMonedaTextController ??= TextEditingController();
    _model.textFieldMonedaFocusNode ??= FocusNode();

    _model.textFieldCostoTextController ??= TextEditingController();
    _model.textFieldCostoFocusNode ??= FocusNode();

    _model.textUnidadTextController ??= TextEditingController();
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await TarifasRecord.collection
                                      .doc()
                                      .set(createTarifasRecordData(
                                        ...
                                        descripcion: _model
                                            ...
                                            .text,
                                        moneda: _model
                                            .textFieldMonedaTextController.text,
                                        precio: double.tryParse(_model
                                            .textFieldCostoTextController.text),
                                        unidad: _model
                                            .textUnidadTextController.text,
                                      ));
                                  safeSetState(() {
                                    ...
                                    _model.textFieldCostoTextController
                                        ?.clear();
                                    _model.textUnidadTextController?.clear();
                                  });
