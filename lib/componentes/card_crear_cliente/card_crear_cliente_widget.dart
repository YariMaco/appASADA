...
import 'card_crear_cliente_model.dart';
export 'card_crear_cliente_model.dart';

class CardCrearClienteWidget extends StatefulWidget {
  const CardCrearClienteWidget({super.key});

  @override
  State<CardCrearClienteWidget> createState() => _CardCrearClienteWidgetState();
}

class _CardCrearClienteWidgetState extends State<CardCrearClienteWidget> {
  late CardCrearClienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardCrearClienteModel());
    ...
    _model.textFieldNacionalidadTextController ??= TextEditingController();
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText: 'Ingrese la nacionalidad',
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Nunito',
                                    ...
                                    children: [
                                      ...
                                      Switch.adaptive(
                                        value: _model.switchValue ??=
                                            card23InboxUsersRecord
                                                    ?.isMeterOwner ==
                                                true,
                                        onChanged: (card23InboxUsersRecord
                                                    ?.isMeterOwner ==
                                                false)
                                            ? null
                                            : (newValue) async {
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await actions.createClient(
                                    ...
                                    _model.textFieldTelefonoTextController.text,
